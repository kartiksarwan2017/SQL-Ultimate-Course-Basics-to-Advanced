/********** 30 SQL Tips and Tricks From 18 Years of Experience ***********/
USE SalesDB;
...
-- Bad practice for small & mid sized tables
SELECT CustomerID
FROM Sales.Orders
UNION 
SELECT CustomerID
...
-- BETTER QUERY WITHOUT MAX and realistic length of the column
CREATE TABLE CustomersInfo (
    CustomerID INT,
...
-- ============================================================================================== --
CREATE TABLE Sales.CustomersInfo (
    CustomerID INT PRIMARY KEY CLUSTERED,
    FirstName VARCHAR(50) NOT NULL,
    LastName VARCHAR(50) NOT NULL,
    Country VARCHAR(50) NOT NULL,
...
CREATE NONCLUSTERED INDEX IX_Good_Customers_EmployeeID ON Sales.CustomersInfo(EmployeeID);
